...
class Player(pygame.sprite.Sprite):
    ...
    def use_tool(self):
        ...
        if self.selected_tool == 'water':
            ...
            self.sound_manager.watering.play()
    ...
    def handle_seed_input(self, keys):
        # seed use
    ...
    def handle_interaction_input(self, keys):
    ...
    def handle_collision(self, direction, sprite):
    ...
    def collision(self, direction):
        for sprite in self.collision_sprites.sprites():
            if hasattr(sprite, 'hitbox') and sprite.hitbox.colliderect(self.hitbox):
                self.handle_collision(direction, sprite)
